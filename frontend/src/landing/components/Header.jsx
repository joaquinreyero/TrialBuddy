...
const navigation = [
  ...
  { name: 'Testimonial', href: '#', action: 'product' },
  { name: 'Pricing', href: '#', action: 'pricing' },
  { name: 'Contact', href: '#', action: 'contact' },
];

export const Header = ({ scrollToProduct, scrollToPricing, scrollToContact }) => {
        ...
        <header className="absolute inset-x-0 top-0 z-50">
          <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div className="flex lg:flex-1">
              ...
              <p className='ml-2 text-2xl font-semibold whitespace-nowrap text-gray-800'>TrialBuddy</p>
            </div>
